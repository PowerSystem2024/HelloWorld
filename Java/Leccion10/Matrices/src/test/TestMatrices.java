...
public class TestMatrices {
    public static void main(String[] args) {
        ...
        edades[1][1] = 13;
        edades[2][0] = 17;
        edades[2][1] = 19; // Terminamos la tarea
...
//        }
        ...
        personas[0][2] = new Persona("Carla");
        personas[1][0] = new Persona("Miguel");
        personas[1][1] = new Persona("Lucía");
        personas[1][2] = new Persona("Javier");
